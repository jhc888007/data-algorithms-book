...
class SparkTupleComparator2 
	implements Comparator<Tuple2<Integer, Double>>, Serializable {
	 
	public static final SparkTupleComparator2 INSTANCE = new SparkTupleComparator2();
	
	private SparkTupleComparator2() {
	}
...
public class MovieRecommendationsSelfPredict {
	  public static void main(String[] args) throws Exception {
		...
		MatrixFactorizationModel model = MatrixFactorizationModel.load(jsc.sc(), args[3]+"/model");
		...
		//predictions.saveAsTextFile(args[3]+"/predictions");
		...
		JavaPairRDD<Integer, Iterable<Tuple2<Integer, Double>>> predictionsSort = predictionsGroup.mapValues(
			new Function<Iterable<Tuple2<Integer, Double>>, Iterable<Tuple2<Integer, Double>>>() {
				public Iterable<Tuple2<Integer, Double>> call(Iterable<Tuple2<Integer, Double>> list) {
					...
					Collections.sort(list_new, SparkTupleComparator2.INSTANCE);
					return list_new;
				}
			}
		);
		System.out.println("predictionsSort");
		*/
		...
		System.out.println("usersSample");
		...
		*/
		...
		predictionsSample.saveAsTextFile(args[3]+"/predictionssample");
		usersSample.saveAsTextFile(args[3]+"/usersample");
		//END///////////////////////////////////////////////////
